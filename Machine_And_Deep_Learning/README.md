...
<tr>
    <th style="width:18%; padding:10px; border:1px solid black;">Full Name</th>
    <th style="width:22%; padding:10px; border:1px solid black;">What it does</th>
    <th style="width:25%; padding:10px; border:1px solid black;">How it works</th>
    <th style="width:15%; padding:10px; border:1px solid black;">Specific Example</th>
    <th style="width:12%; padding:10px; border:1px solid black;">Tools / Software</th>
    <th style="width:8%; padding:10px; border:1px solid black;">Relationship</th>
</tr>
